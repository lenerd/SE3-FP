...
; <notmeldung> ::= <ueberschrift> standortangabe notfall_art hilfeleistung 
...
; 
; <rufzeichen> ::= <icao_letter> <icao_letter> <icao_letter> <icao_letter>
; 
; 
...
;                   "Viktor" | "Whiskey" | "X-ray" | "Yankee" | "Zulu"
; 
